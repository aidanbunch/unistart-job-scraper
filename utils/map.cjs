...
const scrapeSimplifyGithub = require("../scrapers/scrapeSimplifyGithub.cjs");

const ScrapingMap = {
	// "https://jobs.sequoiacap.com/jobs/?internshipOnly=true": scrapeConsider,
	...
	// "https://topstartups.io/jobs/?yoe=0-1+year&yoe=2-3+years": scrapeTopStartups,
	"https://raw.githubusercontent.com/SimplifyJobs/Summer2024-Internships/dev/README.md": scrapeSimplifyGithub,
};
